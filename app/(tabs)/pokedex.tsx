...
export default class Pokedex extends Component<{}, State> {
    state: State = {
        pokedex: [],
        modalVisible: false,
    ...
    fetchPokemon = async (index: number) => {
    ...
    renderPokemonItem = ({ item, index }: { item: any; index: number }) => (
    ...
    onPressPokemonItem = (index: number) => {
